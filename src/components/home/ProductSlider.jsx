...
//   const itemsPerPage = window.innerWidth < 768 ? 1 : 3; // 1 item for small screens, 3 for larger screens
...
//         <div
//           className={`flex transition-transform duration-500 ease-in-out ${window.innerWidth < 768 ? '' : 'gap-4'}`}
...
//               style={{ flex: `0 0 ${window.innerWidth < 768 ? 100 : 100 / itemsPerPage}%` }}
//             >
