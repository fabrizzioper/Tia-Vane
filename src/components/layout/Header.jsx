    ...
    <header className="w-full bg-white">
      <div className="max-w-[1800px] mx-auto px-8">
        <div className="flex items-center justify-between h-24">
          ...
          {/* Campo de búsqueda e iconos */}
          <div className="flex items-center space-x-2">
            <div className="relative block w-40 lg:w-60">
              <input
                type="text"
                placeholder="Buscar"
                className="pl-10 pr-4 py-2 rounded-full bg-gray-100 focus:outline-none 
                           focus:ring-2 focus:ring-gray-200 w-full"
                value={localSearch}
                onChange={handleSearchChange}
                onKeyDown={handleKeyDown} // Detectar Enter
              />

              {/* Ícono de búsqueda como botón dentro del input */}
              <button
                type="button"
